...
public class ConversationManager implements Startable, ComponentEventListener {
	...
	private static final String INSERT_MESSAGE = "INSERT INTO ofMessageArchive(conversationID, fromJID, fromJIDResource, toJID, toJIDResource, sentDate, body, customcolumn) "
			+ "VALUES (?,?,?,?,?,?,?,?)";
